...
namespace Edu.DataAccess.Migrations
{
    ...
    [Migration("20230716222917_AboutTambleCreate")]
    partial class AboutTambleCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edu.Core.Entities.About", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Edu.Core.Entities.TeacherDetaile", b =>
                {
                    b.HasOne("Edu.Core.Entities.Teacher", "Teacher")
                        .WithOne("teacherDetaile")
                        .HasForeignKey("Edu.Core.Entities.TeacherDetaile", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
